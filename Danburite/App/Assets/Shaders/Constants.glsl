...
const uint GOURAUD_RENDERER_TRANSFORM_MATERIAL_SLOT_IDX		= 0U;
const uint GOURAUD_RENDERER_GOURAUD_MATERIAL_SLOT_IDX		= 1U;
...
const uint GOURAUD_MATERIAL_LOCATION				= 1U;
const uint PHONG_MATERIAL_LOCATION					= 2U;
const uint LIGHT_MATERIAL_LOCATION					= 3U;
